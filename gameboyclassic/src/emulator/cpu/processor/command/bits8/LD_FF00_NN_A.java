 ...
 */
public class LD_FF00_NN_A extends CommandsImpl {

    /**
     * Put A into memory address $FF00+n - 0xE
     *
     * @param z80
     */
    public LD_FF00_NN_A(Z80 z80) {
        super(z80);
    }

    @Override
    public void runAsync(int opCode1, int opCode2, int opCode3, int opCode4) {
        super.addressWrite(0xFF00 + opCode2, z80.a, 2, 12);
    }
}
