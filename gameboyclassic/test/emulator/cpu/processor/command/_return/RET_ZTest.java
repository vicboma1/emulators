 ...
 */
public class RET_ZTest extends TestCase {
    ...
    public void testFlagNull() throws Exception {
        z80.register8Bits.f = Flags.HALFCARRY;

        this.ret_z.execute(0, 0,0,0);

        assertTrue("Not same pc", this.z80.register16bits.pc == 1);
        assertTrue("Not same z80.registers8bits.f", this.z80.register8Bits.f == Flags.HALFCARRY);
    ...
    public void testFlagZero() throws Exception {
        ...
        assertTrue("Not same z80.registers8bits.f", z80.register8Bits.f == Flags.ZERO);
